# =================================== Modifications for Obstacle Car Racing ============================================
# This version of includes some minor changes to support the Obstacle Car Racing environment, such as:
# - Hull and wheels are annotated with metadata (e.g. car_id, wheel labels) to enable per-car identification.
# - Skid trace rendering code is disabled to improve visual clarity.
# ======================================================================================================================
...
wheel_name = ["front-left", "front-right", "rear-left", "rear-right"]

class Car:
    def __init__(self, world, init_angle, init_x, init_y, car_id=None, SIZE=0.02):
        self.SIZE = SIZE
        self.ENGINE_POWER = 100000000 * self.SIZE * self.SIZE
        self.WHEEL_MOMENT_OF_INERTIA = 4000 * self.SIZE * self.SIZE
        self.FRICTION_LIMIT = (
                1000000 * self.SIZE * self.SIZE
        ...
        # self.hull.userData = self.hull # not sure why this is not working
        # self.hull.hull_car_id = self.car_id
        self.hull.userData = self # the obj will be the whole car
        ...
        for i, (wx, wy) in enumerate(WHEELPOS):
            ...
            w.wheel_car_id = self.car_id
            w.label = wheel_name[i]
